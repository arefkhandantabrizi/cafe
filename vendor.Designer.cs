...
namespace HomeCafe {
    ...
    public partial class vendor : global::System.Data.DataSet {
        ...
        public partial class vendorDataTable : global::System.Data.TypedTableBase<vendorRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public vendorRow AddvendorRow(string name, string address, string tel) {
        ...
        public partial class vendorRow : global::System.Data.DataRow {
            ...
            public string tel {
                get {
                    try {
                        return ((string)(this[this.tablevendor.telColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'tel\' in table \'vendor\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablevendor.telColumn] = value;
                }
            }
            ...
            public bool IstelNull() {
                return this.IsNull(this.tablevendor.telColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SettelNull() {
                this[this.tablevendor.telColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace HomeCafe.vendorTableAdapters {
    ...
    public partial class vendorTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[vendor] WHERE (([id] = @Original_id) AND ([name] = @Original_n" +
                "ame) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_" +
                "address)) AND ((@IsNull_tel = 1 AND [tel] IS NULL) OR ([tel] = @Original_tel)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[vendor] ([name], [address], [tel]) VALUES (@name, @address, @t" +
                "el);\r\nSELECT id, name, address, tel FROM vendor WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[vendor] SET [name] = @name, [address] = @address, [tel] = @tel WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_tel = 1 AND [tel] IS NULL) OR ([tel] = @Original_tel)));
SELECT id, name, address, tel FROM vendor WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, address, tel FROM dbo.vendor";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_address, string Original_tel) {
        ...
        public virtual int Update(string name, string address, string tel, int Original_id, string Original_name, string Original_address, string Original_tel, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string address, string tel, int Original_id, string Original_name, string Original_address, string Original_tel) {
            return this.Update(name, address, tel, Original_id, Original_name, Original_address, Original_tel, Original_id);
        }
    }
